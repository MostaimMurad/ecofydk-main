  ...
  return (
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-20 right-1/4 w-96 h-96 bg-emerald-500/10 rounded-full blur-[100px]"
      />
      <motion.div
        animate={{ scale: [1, 1.2, 1], opacity: [0.03, 0.06, 0.03] }}
        transition={{ duration: 12, repeat: Infinity, delay: 3 }}
        className="absolute bottom-20 left-1/4 w-96 h-96 bg-primary/10 rounded-full blur-[100px]"
      />
